...
public class Constants {
    ...
    public enum PLACE_TYPES {
        ...
        GOOGLE_PLACES_SLEEP("Sleep in", R.color.ab_color_green, "best hotel| lodging"),

        GOOGLE_PLACES_EAT("Eat in", R.color.ab_color_blue, "restaurant|food|bakery|meal_delivery|meal_takeaway|food"),

        GOOGLE_PLACES_ENJOY("Enjoy in", R.color.ab_color_purple, "museum|park|monument|buddhist temple"),
